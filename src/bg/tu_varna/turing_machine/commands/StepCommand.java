...
public class StepCommand implements Command {
    ...
    public StepCommand(MachineRegistry r) { this.registry = r; }
    @Override public String execute(String[] args) {
        ...
        if (!moved && turingMachineRunner.isHalted()) return "Halted: " + turingMachineRunner.getHaltReason() + " (accepted=" + turingMachineRunner.isAccepted() + ")";
